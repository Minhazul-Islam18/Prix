            ...
            <div x-data="{ tab: 'general' }" x-cloak class="m-4 sm:m-6 md:m-10 antialiased">
                <div class="flex flex-col items-start justify-start md:flex-row md:items-start md:justify-start gap-2">
                    ...
                    <div class="w-full md:w-3/4 lg:w-3/4 overflow-y-scroll">
                        ...
                        <div x-show="tab === 3" x-transition:enter.duration.500ms x-transition:leave.duration.200ms>
                            {{ 'Tab 3' }}
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsum officiis vero incidunt
                                tempore soluta deleniti! Quibusdam ipsum cum temporibus qui.</p>
                        </div>
